...
export class HojaDeVidaIndustrialService {
    ...
    /**
     * Obtiene la imagen de un equipo industrial usando la ruta almacenada en hojaVida.foto
     * Usa el endpoint público /imagenequipohv (POST con { ruta })
     */
    getImagenEquipo(rutaFoto: string): any {
        return this.httpClient.post(`${API_URL}/imagenequipohv`, { ruta: rutaFoto }, {
            responseType: 'blob'
        });
    }
}
