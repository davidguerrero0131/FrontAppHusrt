...
export class RegistroComponent implements OnInit {
  ...
  constructor(
    ...
    this.formGroup = this.formBuilder.group({
      ...
      tipoId: new FormControl('CC', [Validators.required]),
    ...
    try {
      ...
      if (!this.roles || this.roles.length === 0) {
        Swal.fire({
          ...
          text: 'No se encontraron roles en el sistema. Contacte al administrador.'
        });
      }
    } catch (error) {
      ...
      Swal.fire({
        ...
        text: 'No fue posible cargar los roles disponibles. Verifique su conexión.'
      });
    }
  }
