...
export class EditarHojaDeVidaEquipoComponent implements OnInit {
    ...
    idFabricanteSeleccionado: any = 'nuevo';
        ...
        try {
            ...
            try {
                ...
                if (hojaVida) {
                    ...
                    if (hojaVida.fabricanteIdFk) {
                        this.idFabricanteSeleccionado = hojaVida.fabricanteIdFk;
                        this.seleccionarFabricante({ target: { value: hojaVida.fabricanteIdFk } });
                    }
                }
