// Server Backend
export const API_URL = 'http://172.30.20.18:3006';// Server Servinte
export const API_SERVINTE_URL = 'http://172.30.20.18:3002';
// Server Enterprice
export const API_ENTERPRICE_URL = 'http://172.30.20.18:3003';
// Server Rafa IA
...
export const ROLE_REDIRECTS: Record<string, string> = {
  ...
  'SYSTEMUSER': '/adminsistemas',
  'SYSTEMTECNICO': '/adminsistemas',
  'SISTEMASTECNICO': '/adminsistemas',
  'SUPERADMIN': '/superadmin',
  'MANTENIMIENTOADMIN': '/adminmantenimiento',
  'BIOMEDICAADMIN': '/adminbiomedica',
  'BIOMEDICAUSER': '/gestion-operativa',
  'BIOMEDICATECNICO': '/gestion-operativa',
  'MESAUSER': '/mesaservicios',
  'MESAADMIN': '/mesaservicios',
  'AG': '/mesaservicios',
  'MESADESERVICIOSAGENTE': '/mesaservicios',
