...
// Mesa de Servicios Components
import { MainLayoutComponent } from './Components/mesaServicios/layout/main-layout.component';
import { DashboardComponent } from './Components/mesaServicios/dashboard/dashboard.component';
import { ListaCasosComponent } from './Components/mesaServicios/casos/lista-casos.component';
import { NuevoCasoComponent } from './Components/mesaServicios/casos/nuevo-caso.component';
import { DetalleCasoComponent } from './Components/mesaServicios/casos/detalle-caso.component';
import { ServiciosAdminComponent } from './Components/mesaServicios/admin/servicios-admin.component';
import { UsuariosAdminComponent } from './Components/mesaServicios/admin/usuarios-admin.component';
import { ListaCategoriasComponent } from './Components/mesaServicios/categorias/lista-categorias.component';
import { ListaAreasComponent } from './Components/mesaServicios/areas/lista-areas.component';
import { ListaUsuariosComponent } from './Components/mesaServicios/usuarios/lista-usuarios.component';

// Mesa de Servicios Guards
import { adminMesaServiciosGuard } from './guards/admin-mesa-servicios.guard';
import { soporteGuard } from './guards/soporte.guard';
...
export const routes: Routes = [
  ...
  // Mesa de Servicios Routes
  {
    ...
    children: [
      ...
      // Rutas de Administración (requieren adminMesaServiciosGuard)
      {
        path: 'admin/servicios',
        component: ServiciosAdminComponent,
        canActivate: [adminMesaServiciosGuard]
      },
      {
        path: 'admin/usuarios',
